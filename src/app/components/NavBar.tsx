...
// Define the interface for the navLinks items
interface NavItem {
  title: string;
  path: string;
}
...
const NavBar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100 border-b border-gray-800">
      <div className="flex flex-wrap items-center justify-between mx-auto p-3 md:p-8">

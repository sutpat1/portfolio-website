...
const HeroSection= () => {
    ...
    />
                ...
                <div className="mt-6">
                    ...
                    <button  className="px-1 py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-dark-blue-500 via-indigo-500 to-pink-500 hover:bg-slate-800 text-white  mt-3">

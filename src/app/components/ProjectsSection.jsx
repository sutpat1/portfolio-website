...
const projectsData = [
  {
    ...
    description: "For this project, I used React, Next.js, and JavaScript to build a personal portfolio website. By leveraging React for dynamic content rendering and Next.js for server-side rendering and optimization, I created a fast, responsive, and SEO-friendly website. I focused on building a clean, user-friendly interface to showcase my projects, skills, and experience, ensuring seamless navigation and a polished user experience.",
